...
if __name__ == '__main__':
    ...
    nu, trans = transmittanceSpectrum(sample_point, output_coef)

    # savemat("a2509_cuLBL_0_LBLResultsCompare_1.mat", {"nu": nu, "trans": trans, "coef": output_coef})
