...
if __name__ == '__main__':
    ...
    data = scipy.io.loadmat('a2509_cuUSAR_outspec_2000.mat')
    P_range = data['Px'].squeeze()
    T_range =  data['Tx'].squeeze()
    ...
    savemat(f'a2509_path_coef_2000.mat', {'Pc': Pdata, 'Tc': Tdata, 'Coef': Coef_data})
